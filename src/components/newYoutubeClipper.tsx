...
//             } = useYouTubeTab();
//
//             // Use ref for clips data
//             const clipsRef = useRef<TimeRange[]>([]);
//             const [, setClipsVersion] = useState(0); // For triggering re-renders
//
//             // Force re-render when clips change
...
//             }, [initializeTab]);
//
//             const isLoading = tabLoading || clipsLoading;
//
//             return (
...
//                             disabled={isLoading || !currentTabUrl.includes('youtube.com/watch')}
//                         >
